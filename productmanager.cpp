    ...
    ui(new Ui::ProductManager)
{
    ...
    ui->productTableView->setColumnWidth(0, 85);
    ui->productTableView->setColumnWidth(1, 150);
    ui->productTableView->setColumnWidth(2, 100);
    ui->productTableView->setColumnWidth(3, 85);
    ui->productTableView->setColumnWidth(4, 100);
...
void ProductManager::loadToClientTable(QSqlTableModel* clientModel) {
    ...
    ui->clientListTableView->setColumnWidth(0, 120);
    ui->clientListTableView->setColumnWidth(1, 100);
    ui->clientListTableView->setColumnWidth(2, 120);
    ui->clientListTableView->setColumnWidth(3, 200);
    ui->clientListTableView->setColumnWidth(4, 100);
}
